...
const flow = ['Kullanıcı oluştur', 'Token al', 'Tarif ekle', 'Etiketlerle düzenle']
      ...
      <section className="hero">
        <div className="hero__copy">
          ...
          <div className="hero__actions">
            <a className="button button--primary" href="/api/docs/" target="_blank" rel="noreferrer">
              Swagger UI
            </a>
            <a className="button button--ghost" href="/api/schema/" target="_blank" rel="noreferrer">
              OpenAPI Schema
            </a>
          </div>
